...
import com.example.myapplication.databinding.FragmentSettingsViewmodelBinding
...
class SettingsFragment : Fragment() {
    private lateinit var binding: FragmentSettingsViewmodelBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentSettingsViewmodelBinding.inflate(layoutInflater, container, false)
        return binding.root
    }
